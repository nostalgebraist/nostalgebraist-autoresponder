...
def run_selector_on_docs_local(docs, save_path="selector.json", batch_size=8, device='cuda:0'):
...
def run_sentiment_on_docs_local(docs, save_path="selector.json", batch_size=8, device='cuda:0'):
    import experimental.ml_layer_torch
    import experimental.ml_connector
