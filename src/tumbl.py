...
WRITE_POSTS_WHEN_QUEUE_BELOW = 13
N_TO_WRITE = 1
...
if USE_SEPARATE_TXT_GUIDANCE:
    ...
    GUIDANCE_SCALE_OPTIONS = (2, 2, 2, 2, 3, 3, 4)  # dynamic thresholding, 4stage, v2, capts
    GUIDANCE_SCALE_OPTIONS_NO_TEXT = (3, 3, 4, 4, 5)  # dynamic thresholding, 4stage, v2, capts
    GUIDANCE_SCALE_OPTIONS_HEAVY_TEXT = (1, 1, 1.5,)  # dynamic thresholding, 4stage, v2, capts
